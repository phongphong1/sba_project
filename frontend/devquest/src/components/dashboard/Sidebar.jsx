          ...
          {sidebarNavItems.map((item) => {
            ...
            return (
              <NavLink
                ...
                className={({ isActive }) =>
                  `group flex w-full flex-col items-center justify-center rounded-[22px] px-3 py-3 transition-all duration-200 ${isActive ? 'text-slate-900' : 'text-slate-500 hover:-translate-y-0.5 hover:text-slate-900'
                  }`
                }
              ...
              >
                {({ isActive }) => (
                  <>
                    <span
                      className={`flex h-11 w-11 items-center justify-center rounded-[18px] ${isActive
